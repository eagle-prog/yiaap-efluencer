...
/*
	...
	$Id: login.inc.php 481 2009-11-29 16:21:11Z matt.simpson $
*/
...
if((isset($_GET["action"])) && ($_GET["action"] == "logout")) {
	$NOTICE++;
	$i = @count($NOTICESTR);
	$NOTICESTR[$i] = "Thank-you for using ListMessenger Light, we hope are finding it a useful tool for your e-mail communication needs.<br /><br />";

	if(time() % 2) {
		$NOTICESTR[$i] .= "If you like ListMessenger please <a href=\"http://www.hotscripts.com/listings/rate/62847?rate=5\" target=\"_blank\">rate ListMessenger</a> at <a href=\"http://www.hotscripts.com/?RID=9600\" target=\"_blank\">HotScripts</a> every day, which helps ListMessenger grow.";
	} else {
		$NOTICESTR[$i] .= "If you like ListMessenger please support the development of our application by <a href=\"http://www.listmessenger.com/pricing\" target=\"_blank\">purchasing ListMessenger Pro</a>.";
	}
}
?>
