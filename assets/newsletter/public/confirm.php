...
/*
	...
	$Id: confirm.php 513 2011-03-09 05:38:08Z matt.simpson $
*/
...
if(!@file_exists($LM_PATH."includes/config.inc.php")) {
	...
	if((!isset($LM_REQUEST["code"])) || (empty($LM_REQUEST["code"])) || (!isset($LM_REQUEST["id"])) || (empty($LM_REQUEST["id"])) || (!$LM_REQUEST["id"] = (int) trim($LM_REQUEST["id"])) || (strlen($LM_REQUEST["code"]) != 32)) {
		$ERROR++;
