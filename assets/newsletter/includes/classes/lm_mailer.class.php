...
class LM_Mailer extends PHPMailer {
	...
	public function ClearCustomHeaders() {
		$this->CustomHeader = array(
			array("X-Mailer", "ListMessenger"." ".VERSION_TYPE." ".VERSION_INFO),
			array("X-ListMessenger-ID", urlencode($this->ListMessengerId)),
			array("X-Originating-IP", clean_input($_SERVER["REMOTE_ADDR"], array("emailheaders")))
		);
	}
	...
	*/
	public function SetWordWrap() {
		...
		if (in_array($this->message_type, array("alt", "alt_attachments"))) {
