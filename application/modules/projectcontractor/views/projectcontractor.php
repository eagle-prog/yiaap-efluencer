  ...
  <div class="row"> <?php echo $leftpanel;?> 
    ...
    <div class="col-md-9 col-sm-8 col-xs-12">
        ...
        <div class="profile_right">
          <h3> All contractor list :: <a href="<?php echo VPATH;?>jobdetails/details/<?php echo $project_id;?>">
            <?=$project_name?>
            </a> </h3>
          <!--EditProfile Start-->
          <div class="editprofile11" id="editprofile">
            ...
            <table id="example" class="table table-dashboard table-striped table-bordered" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>Freenalce Name</th>
                  <th>My Feedback</th>
                  <th>Freelancer Feedback</th>
                  <th>Action</th>
                </tr>
              </thead>
              <tbody>
...
?>
                <tr>
                  ...
                  <td><? if($val['freelancer_feedback']=='Y'){?>
                    <a href="javascript:void(0)" onclick="getFeedback('<?=$project_id?>','<?php echo $val['user_id'];?>')" data-reveal-id="exampleModal_view">Freelancer Feedback</a>
                    <? }?></td>
                  <td><? if($val['end_status']=='N'){?>
                    <a href="javascript:void(0)" onclick="closecontract('<?=$project_id?>','<?php echo $val['user_id'];?>')" data-reveal-id="exampleModal" class="btn btn-site btn-sm" >End Now</a>
                    <?}elseif($val['update_status']=='Y'){echo "End";}else{ ?>
                    <a href="javascript:void(0)" onclick="closecontract('<?=$project_id?>','<?php echo $val['user_id'];?>')" data-reveal-id="exampleModal" class="btn btn-site btn-sm" >Update</a>
                    <? }?></td>
                </tr>
                <?php
}
...
<div id="exampleModal" class="reveal-modal" style="width:70%;margin-left: -35%;" >
  ...
  <div class="editprofile" >
    ...
    <form action="" name="givefeedbackform" class="givefeedbackform" method="POST">
      ...
      <div class="acount_form">
        <p></p>
        <button type="button" onclick="givefeedback()" id="sbmt" class="btn btn-site btn-sm" style="background: #428bca">Send</button>
