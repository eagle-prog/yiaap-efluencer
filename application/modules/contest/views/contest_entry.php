	...
	<?php } ?>
      ...
      <div class="btn-group btn-group-justified" data-toggle="buttons">
        <label class="btn btn-default active">
          ...
          <?php echo __('contest_i_want_to_submit_an_entry_right_away','I want to submit an entry right away')?> </label>
        <label class="btn btn-default">
          <input type="radio" name="entry_type" value="2">
          <?php echo __('contest_i_am_participating_in_this_contest','I am participating in this contest')?> </label>
      </div>
      <br>
      <form id="entry-form" onsubmit="ajaxSubmit(this, event)">
        <div class="form-group">
          <label><?php echo __('entry_title','Entry title')?>: </label>
          <input type="text" name="title" class="form-control" placeholder="<?php echo __('contest_what_entry_title','What is the entry title')?> ?">
        </div>
        <div class="form-group">
          <label><?php echo __('describ','Describe your entry')?>: </label>
          <textarea class="form-control" name="description" placeholder="<?php echo __('describ','Describe your entry')?>, <?php echo __('contest_include','include important details')?>" rows="6"></textarea>
        </div>
        <div class="form-group">
          <label><?php echo __('contest_this_licensed_content','Licensed Content')?>: </label>
          <div class="radio">            
              <input type="radio" class="magic-radio" name="licensed" id="licensed_1" value="1" checked="checked">
              <label for="licensed_1"><?php echo __('contest_this_entry_is_entirely_my_own','This entry is entirely my own')?></label>
          </div>
          <div class="radio">            
              <input type="radio" class="magic-radio" name="licensed" id="licensed_2" value="2">
              <label for="licensed_2"><?php echo __('contest_this_entry_contains_elements_I_did_not_create','This entry contains elements I did not create')?>.</label>
          </div>
        </div>
        <label><?php echo __('contest_Entry_Sell_Price','Entry Sell Price')?>: </label>
        <p><?php echo __('contest_Entry_the_Price','Enter the price you want to sell this entry for. If you don\'t win, the contest holder may still buy your entry at this price')?>. </p>
        ...
        <h4><?php echo __('contest_Promote_my_entry','Promote my entry')?> </h4>
        <table class="table">
          <tr>
            ...
            <td><span class="label label-info"><?php echo __('contest_HIGHLIGHT','HIGHLIGHT')?></span></td>
            <td><?php echo __('contest_highlight_your','Hightlight your entry to make it visually stand out from the rest')?>. </td>
          ...
          <tr>
            ...
            <td><span class="label label-primary"><?php echo __('contest_sealed','SEALED')?></span></td>
            <td><?php echo __('contest_seal_your_entry','Seal your entry to ensure your idea is unique. Only you and the contest holder will be able to view your sealed entry')?>.</td>
        ...
        <div class="form-group">
          <button class="btn btn-site"><?php echo __('contest_Post_My_Entry','Post My Entry')?></button>
        </div>
      </form>
      
	  <form id="participate-form" style="display: none;">
        <div class="participate">
          <p><?php echo __('contest_this_will_notify','Note : This will notify contest holder that you will work on an entry and submit it before the contest ends')?>.</p>
          <div class="form-group">
            <button class="btn btn-site" type="button" onclick="notifyHolder()"><?php echo __('contest_Submit','Submit')?></button>
          </div>
        </div>
      </form>
      </div>
      ...
      <div class="file-dropper-wrapper">
        <div class="file-dropper text-center">
          <div class="input-file">
            <h5><?php echo __('contest_Add_Files','Add Files')?></h5>
            <input type="file" onchange="uploadFiles(this)">
            <button type="button" class="btn btn-site"><?php echo __('contest_Browse_Your_Files','Browse Your Files')?></button>
          </div>
        </div>
        ...
        <div class="clearfix"></div>
        <p><?php echo __('contest_please','Please ensure you have read the contest brief and feedback left by the contest holder on the public clarification board. Support files types are')?> : <b>JPG, PNG, GIF</b> . </p>
