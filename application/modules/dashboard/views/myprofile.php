        ...
        <div class="profile-section">
            <a href="javascript:void(0)" class="btn btn-cover" onclick="$('#coverModal').modal('show');">
                <!--<img src="<?php // echo IMAGE;?>camera-icon.png" alt="Cover Photo" />--><i
                        ...
                        style="line-height: 0.5;vertical-align: middle;"></i> <?php echo __('myprofile_change_cover_photo', 'Change cover photo'); ?>
            </a>
            <div class="clearfix">
                <aside class="col-md-9 col-sm-12 col-xs-12">
                    <div class="row">
                      ...
                      $u_row = get_row(array('select' => '*', 'from' => 'user', 'where' => array('user_id' => $user[0]->user_id)));
                    ...
                    <div class="profileEdit">
                      <?php if ($user_id == $user_login) { ?>
                          <a href="<?php echo base_url('findjob') ?>" class="btn btn-site btn-lg btn-block hidden"><i
                                      class="zmdi zmdi-case"></i> <?php echo __('myprofile_find_job', 'Find Job'); ?>
                          </a>
                      ...
                      <?php } ?>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item hidden"><i
                                        class="zmdi zmdi-smartphone"></i> <?php echo __('dashboard_profileprofessional_payment_verified', 'Payment Verified'); ?>
                              <?php if ($u_row['payment_verified'] == 'Y') {
                                echo '<span class="pull-right f-12">' . __('myprofile_emp_verified', 'Verified') . '</span>';
                              } else { ?>
                              ...
                              <?php if ($u_row['email_verified'] == 'Y') {
                                echo '<span class="pull-right"><i class="zmdi zmdi-hc-2x zmdi-check-circle" title="' . __('myprofile_emp_verified', 'Verified') . '" style="color:#0c0; line-height:20px"></i></span>';
                                  ...
                                  <button class="btn btn-xs btn-site pull-right"
                                          onclick="verify('email')"><?php echo __('myprofile_verify', 'Verify'); ?></button>
                              <?php } ?>
                            </li>
                            <li class="list-group-item hide">
                              ...
                              <?php if ($u_row['phone_verified'] == 'Y') {
                                echo '<span class="pull-right"><i class="zmdi zmdi-hc-2x zmdi-check-circle" title="' . __('myprofile_emp_verified', 'Verified') . '" style="color:#0c0; line-height:20px"></i></span>';
                                  ...
                                  <button class="btn btn-xs btn-site pull-right"
                                          onclick="verify('phone')"><?php echo __('myprofile_verify', 'Verify'); ?></button>
                              <?php } ?>
                            </li>
                        </ul>
                ...
                <div class="listing">
                    <article class="block panel panel-default">
                        <div class="panel-heading">
                            <h4 class="block-title"><?php echo __('myprofile_work_experience', 'Work Experience'); ?>:
                                <a href="javascript:void(0)" class="edit hidden" data-toggle="modal"
                                   data-target="#myModal2"><i class="zmdi zmdi-edit"></i></a></h4>
                        </div>
                        <div class="panel-body">
                                  ...
                                  <?php if (count($experiences) > 0) {
                                    foreach ($experiences as $k => $v) { ?>
                                        <div id="experience_<?php echo $v['experience_id']; ?>">
                                            <h4><?php echo $v['title']; ?>
                                                <a class="pull-right icon-round"
                                                   data-experience-data='<?php echo htmlentities(json_encode($v), ENT_QUOTES); ?>'
                                                   data-experience-id="<?php echo $v['experience_id']; ?>"
                                                   onclick="editExperience(this)"
                                                   title="<?php echo __('myprofile_edit', 'Edit'); ?>"><i
                                                            class="zmdi zmdi-edit"></i></a> <a
                                                        class="pull-right icon-round"
                                                        data-experience-id="<?php echo $v['experience_id']; ?>"
                                                        onclick="deleteExperience(<?php echo $v['experience_id']; ?>)"
                                                        title="<?php echo __('myprofile_delete', 'Delete'); ?>"><i
                                                            class="zmdi zmdi-delete"></i></a>
                                            </h4>
                                            <p><b><?php echo $v['company']; ?></b> <?php echo $v['start_year']; ?>
                                                - <?php echo $v['currently_working'] == 'Y' ? __('myprofile_present', 'Present') : $v['end_year']; ?>
                                            </p>
                                    ...
                                    <?php }
                                      ...
                                      <div id="no_experience"><p>
                                              <b><?php echo __('myprofile_no_experience_added_yet', 'No experience added yet'); ?></b>
                                          </p></div>
                                  <?php } ?>

                                </div>
                                <div class="btn-wrapper">
                                    <button type="button" class="btn btn-site" onclick="addNewExperience()"><i
                                                class="fa fa-plus"></i> <?php echo __('myprofile_add_experience', 'Add Experience'); ?>
                                    </button>
                                </div>
                            </div>
                            ...
                            <form class="form" id="experienceForm" style="display:none;">
                                ...
                                <div class="form-group">
                                    <div class="checkbox checkbox-inline">
                                        <input type="checkbox" name="currently_working" id="currently_working"
                                               class="magic-checkbox" value="Y" onchange="toggleExpEndYear(this);">
                                        <label for="currently_working"><?php echo __('myprofile_currently_working_here', 'currently working here'); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-site" onclick="saveExperience()"
                                            id="save-experience-btn"><?php echo __('myprofile_save', 'Save'); ?></button>&nbsp;
                                    <button type="button" class="btn btn-grey" onclick="cancelExperience()"
                                            id="cancel-education-btn"><?php echo __('myprofile_cancel', 'Cancel'); ?></button>
                                </div>
                            </form>
                    ...
                    <article class="block panel panel-default">
                        <div class="panel-heading">
                            <h4 class="block-title"><?php echo __('myprofile_education', 'Education'); ?>:
                                <a href="#"
                                   class="edit hidden"
                                   data-toggle="modal"
                                   data-target="#myModal3">
                                    <i class="zmdi zmdi-edit"></i></a></h4>
                        </div>
                        <div class="panel-body">
                                  ...
                                  <?php if (count($educations) > 0) {
                                    foreach ($educations as $k => $v) {
                                      ...
                                      ?>
                                        <div id="education_<?php echo $v['education_id']; ?>">
                                            <h4><?php echo $v['degree']; ?> <a class="pull-right icon-round"
                                                                               data-education-data='<?php echo htmlentities(json_encode($v), ENT_QUOTES); ?>'
                                                                               data-education-id="<?php echo $v['education_id']; ?>"
                                                                               onclick="editEducation(this)"
                                                                               title="<?php echo __('myprofile_edit', 'Edit'); ?>"><i
                                                            class="zmdi zmdi-edit"></i></a> <a
                                                        class="pull-right icon-round"
                                                        data-education-id="<?php echo $v['education_id']; ?>"
                                                        onclick="deleteEducation(<?php echo $v['education_id']; ?>)"
                                                        title="<?php echo __('myprofile_delete', 'Delete'); ?>"><i
                                                            class="zmdi zmdi-delete"></i></a></h4>
                                    ...
                                    <?php }
                                      ...
                                      <div id="no_education"><p>
                                              <b><?php echo __('myprofile_you_have_not_added_any_education_yet', 'You have not added any education yet.'); ?></b>
                                          </p></div>
                                  <?php } ?>

                                </div>
                                <div class="btn-wrapper">
                                    <button type="button" class="btn btn-site" onclick="addNewEducation()"><i
                                                class="fa fa-plus"></i> <?php echo __('myprofile_add_educaton', 'Add Education'); ?>
                                    </button>
                                </div>
                            </div>
                            <form class="form form-horizontal" id="educationForm" style="display:none">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="edu_univeristy"
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-site" onclick="saveEducation()"
                                                id="save-education-btn"><?php echo __('myprofile_save', 'Save'); ?></button>&nbsp;
                                        <button type="button" class="btn btn-grey" onclick="cancelEducation()"
                                                id="cancel-education-btn"><?php echo __('myprofile_cancel', 'Cancel'); ?></button>
                                    </div>
                                </div>
                    ...
                    <article class="block panel panel-default">
                        <div class="panel-heading">
                            <!--<h4 class="block-title">Skills & Knowledge: <a href="<?php // echo VPATH;?>dashboard/editprofile_skill" class="edit"><i class="zmdi zmdi-edit"></i></a></h4>-->
                            <h4 class="block-title"><?php echo __('myprofile_skills_knowledge', 'Skills & Knowledge'); ?>
                                : <a href="javascript:void(0)" data-toggle="modal" data-target="#skillModal"
                                     class="edit"><i class="zmdi zmdi-edit"></i></a></h4>
                        </div>
                        <div class="panel-body">
                            <ul class="skills">
                              <?php
                              if (count($user_skill)) {
                                ...
                                ?>
                                  <li>
                                      <a href="javascript:void(0);"><?php echo __('myprofile_skill_not_set_yet', 'Skill Not Set Yet'); ?></a>
                                  </li>
                                <?php
                              }
                              ?>
                    ...
                    <article class="block panel panel-default">
                        <div class="panel-heading">
                            <h4 class="block-title"><?php echo __('myprofile_certificates', 'Certificates'); ?> <a
                                        href="#" class="edit hidden" data-toggle="modal" data-target="#myModal4"><i
                                            class="zmdi zmdi-edit"></i></a></h4>
                        </div>
                        <div class="panel-body">
                            <div id="certificationWrapperAll">
                                  ...
                                  <?php if (count($certificates) > 0) {
                                    foreach ($certificates as $k => $v) { ?>
                                        <div id="certificate_<?php echo $v['certificate_id']; ?>">
                                            <h4><?php echo $v['title']; ?>
                                                ( <?php echo $v['duration']; ?> <?php echo __('myprofile_month', 'month'); ?>
                                                )
                                                <a class="pull-right icon-round"
                                                   title="<?php echo __('myprofile_edit', 'Edit'); ?>"
                                                   data-certificate-id="<?php echo $v['certificate_id']; ?>"
                                                   data-certificate-data='<?php echo htmlentities(json_encode($v), ENT_QUOTES); ?>'
                                                   onclick="editCertification(this)"><i class="zmdi zmdi-edit"></i></a>

                                                <a class="pull-right icon-round"
                                                   title="<?php echo __('myprofile_delete', 'Delete'); ?>"
                                                   data-certificate-id="<?php echo $v['certificate_id']; ?>"
                                                   onclick="deleteCertificate(<?php echo $v['certificate_id']; ?>)"><i
                                                            class="zmdi zmdi-delete"></i></a>
                                            </h4>
                                ...
                                <div class="btn-wrapper">
                                    <button type="button" class="btn btn-site" onclick="addNewCertification()"><i
                                                class="fa fa-plus"></i> <?php echo __('myprofile_add_certification', 'Add Certification'); ?>
                                    </button>
                                </div>
                            </div>
                            ...
                            <form class="form" id="certificationForm" style="display:none;">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-site" onclick="saveCertification()"
                                            id="save-certificate-btn"><?php echo __('myprofile_save', 'Save'); ?></button>&nbsp;
                                    <button type="button" class="btn btn-grey" onclick="cancelCertification()"
                                            id="cancel-certificate-btn"><?php echo __('myprofile_cancel', 'Cancel'); ?></button>
                                </div>
                    ...
                    <article class="block panel panel-default">
                        <div class="panel-heading">
                            <h4 class="block-title"><?php echo __('myprofile_portfolio', 'Portfolio'); ?> <a
                                        href="javascript:void(0)" data-toggle="modal" data-target="#addPortfolioModal"
                                        class="edit"><i class="zmdi zmdi-plus"></i></a> <a
                                        href="<?php echo VPATH; ?>dashboard/editportfolio" class="edit"
                                        style="margin-left:10px; margin-right:10px"><i
                                            class="zmdi zmdi-settings"></i></a></h4>
                        </div>
                        <div class="panel-body">
                                  ...
                                  if ($extension == "zip" && $extension == "doc" && $extension == "docx" && $extension == "pdf" && $extension == "xls" && $extension == "xlsx" && $extension == "txt") {
                                    ?>
                                      <li><a style="cursor: pointer;"
                                             ...
                                             target="_blank" class="skilslinks"><?php echo $val['title']; ?></a>
                                          <br>
...
<div class="modal fade" id="addPortfolioModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <form id="portfolioForm" onsubmit="dashboard.savePortfolio(this, event);">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" onclick="$('#addPortfolioModal').modal('hide');"><span
                ...
                Browse&hellip; <input type="file" class="form-control" size="30" name="userfile" id="userfile" onchange="movefile(this)" style="display: none;" multiple>
                    ...
                    <?php echo __('myprofile_browse', 'Browse'); ?>&hellip; <input type="file" class="form-control"
                                ...
                                <span style="color:red;float:left;width:100%;">
                                 <?php echo __('myprofile_allowed_files', 'jpg, png , jpeg and gif files are allowed.'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="profileModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="$('#profileModal').modal('hide')">
...
<div class="modal fade" id="coverModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="$('#coverModal').modal('hide')"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"
...
<div class="modal fade" id="inviteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="$('#inviteModal').modal('hide')"><span
                            aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="overviewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false"
     aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                            onclick="$('#overviewModal').modal('hide')"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <form action="" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" onclick="$('#myModal2').modal('hide')">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <form action="" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" onclick="$('#myModal3').modal('hide')">
                        <span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <form action="" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" onclick="$('#myModal4').modal('hide')">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="email_verification_section" class="verifySection">
                    <p><?php echo __('myprofile_click_here', 'click here'); ?><b><?php echo $user[0]->email; ?></b>.
                        <span class="hidden"><?php echo __('myprofile_if_this_is_not_your_email_then', 'If this is not your email then'); ?> <a
                                    href="#"><?php echo __('myprofile_click_here', 'click here'); ?></a> <?php echo __('myprofile_to_change_your_email_address', 'to change your email address'); ?></span>
                    </p>
                </div>
                <div id="phone_verification_section" class="verifySection">
                    <form id="phone_verify_form" class="verifySection">
                        <input type="text" id="phone_no" value="" placeholder="Enter 10 digit phone/mobile number"
                               class="form-control"/>
                        <span id="phoneError" class="rerror"></span>

                        <button type="button" class="btn btn-site btn-block" onclick="verify_phone();"
                                style="margin-top:15px"><?php echo __('myprofile_send_verification_code', 'Send Verification Code'); ?></button>
                    </form>
                    ...
                    <form id="phone_code_verify_form" class="verifySection">
                        ...
                        <input type="text" id="phone_ver_code" name="phone_ver_code" value=""
                               placeholder="<?php echo __('myprofile_enter_the_verification_code', 'Enter the verification code'); ?>"
                               class="form-control"/>
                        <input type="hidden" id="phone_num" name="phone_num"/>
                        <span id="phoneCodeError" class="rerror"></span>
                        <button type="button" class="btn btn-success"
                                onclick="verify_phone_code();"><?php echo __('myprofile_verify', 'Verify'); ?></button>
                    </form>
...
<div id="hourly_rateModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-sm">
        <form action="" method="post" class="form-horizontal">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                            onclick="$('#hourly_rateModal').modal('hide');">&times;
                    </button>
                ...
                <div class="modal-body">
                    <div class="form-group availability-group">
                        ...
                        <div class="col-xs-12">
                            <div class="btn-group special" role="group" aria-label="Default button group">
                                <button type="button" data-hours="true"
                                        class="btn <?php echo $available_hr > 0 ? 'btn-success' : ''; ?>">
                                  <?php echo __('myprofile_emp_available', 'Available'); ?>
                                </button>
                                <button type="button"
                                        class="btn <?php echo $available_hr <= 0 ? 'btn-success' : ''; ?>">
                                  <?php echo __('myprofile_emp_not_available', 'Not Available'); ?>
                                </button>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <input type="number" name="available_week"
                                   class="form-control <?php echo $available_hr <= 0 ? 'hidden' : ''; ?>"
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        if (res['status'] == 1) {
          ...
          $('#phone_verification_status_section').html('<p><?php echo __('myprofile_invalid_code', 'Invalid Code')?> <button onclick="verify(\'phone\')" class="btn btn-primary"><?php echo __('myprofile_try_again', 'Try Again')?></button></p>');
...
<script>
  ...
  $(function () {
    ...
    var $hours = $('.availability-group input');
    var $availabilityGroup = $('.availability-group');
    $availabilityGroup.on('click', '.btn', function () {
      var $clicked = $(this);
      $availabilityGroup.find('.btn').removeClass('btn-success');
      $clicked.addClass('btn-success');
      if ($clicked.data('hours') === true) {
        $hours.val(0)
          .attr('min', 1)
          .removeClass('hidden');
      } else {
