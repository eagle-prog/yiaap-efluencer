...
;(function($) {	
    ...
    $.fn.genyxAdmin = function(options) { 
        ...
        var _this;
        var navMoreDown = '<span class="more"><i class="la ' + settings.navigation.navMoreIconDown + '"></i></span>';
        var navMoreUp = '<span class="more"><i class="la ' + settings.navigation.navMoreIconUp + '"></i></span>';
        var collapseNavIcon = '<i class="la ' + settings.collapseNavIcon + '"></i>';
        var collapseNavRestoreIcon = '<i class="la ' + settings.collapseNavRestoreIcon + '"></i>';
        var accordionIconShow = '<i class="la ' + settings.accordionIconShow + '"></i>';
        var accordionIconHide = '<i class="la ' + settings.accordionIconHide + '"></i>';
        ...
        if(settings.backToTop) {
            ...
            if(!$('#back-to-top').length) {
                //create back to top
                $('body').append('<div id="back-to-top"><a href="#"><i class="la la-rocket la-2x"></i></a></div>');
            }
            backToTop();
        }
       ...
       function setCurrentNav () {
		...
		// CARD
		function widgetBoxNew () {
            var widget = $('.card');
            var w_minimize = widget.find('.card-header a.minimize');
            var widgetClosed = $('.card.closed');
            var widgetDrag = $('.card.drag');

            //Drag widget
            if(widgetDrag) {
                widgetDrag.find('.card-header').addClass('drag');
                dragWidgets();
            }
            
            //close widget
            widgetClosed.each(function(index) {
               $(this).find('.card-header a.minimize').removeClass('minimize').addClass('maximize');
               wcontent = $(this).find('div.card-body');
               wcontent.removeClass('slideDown').addClass('slideUp');
            });
            ...
            w_minimize.on('click', function() {
                _this = $(this);
                if($(this).hasClass('minimize')) {
                    $(this).removeClass('minimize').addClass('maximize').closest('div.card-header').next('div.card-body').slideUp('200')
                } else {
                    $(this).removeClass('maximize').addClass('minimize').closest('div.card-header').next('div.card-body').slideDown('200');
                }
            }); 
        }
        ...
        function resBtnSearch () {
            ...
            $('#header .navbar').prepend('<a href="javascript:void(0)" id="resBtnSearch"><i class="icon16 i-search-3"></i></a>');
            resBtnSearchClick();
        }
        ...
        function resBtn () {
            $('#header .navbar').prepend('<a href="javascript:void(0)" id="resBtn"><i class="la la-navicon"></i></a>');
            resBtnClick();
        }
