...
$(document).ready(function() {
    ...
    $.genyxAdmin({
        ...
        navigation: {
            ...
            navMoreIconDown: 'la-angle-down', //icon for down state.
            navMoreIconUp: 'la-angle-up',//icon for up state
        ...
        collapseNavIcon: 'la-angle-left', //icon for collapse navigation button
        collapseNavRestoreIcon: 'la-angle-right', //icon for restore navigation button
        ...
        accordionIconShow: 'la-angle-down',//icon for accordion expand
        accordionIconHide: 'la-angle-up',//icon for accordion hide
        showThemer: false
    });
