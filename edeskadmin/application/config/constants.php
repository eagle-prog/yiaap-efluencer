...
define('URL', 'https://www.vipleyo.com/efluencer/edeskadmin/');

define('VPATH', 'https://www.vipleyo.com/efluencer/edeskadmin/');

define('APATH', $_SERVER['DOCUMENT_ROOT'] . "/efluencer/edeskadmin/");
