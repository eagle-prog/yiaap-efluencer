...
class Invoice extends MX_Controller {
    ...
    public function index() {
		...
		redirect(base_url('invoice/list_all'));
	...
	public function list_all($limit_from=0){
		...
		$data['all_data'] = $this->invoice_model->getInvoiceList($srch,  $start, $per_page);
		$data['all_data_count'] = $this->invoice_model->getInvoiceList($srch, '', '', FALSE);
