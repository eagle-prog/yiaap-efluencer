...
class Home_skills extends MX_Controller {
    ...
    public function __construct() {
        $this->load->model('home_skills_model');
    ...
    public function index() {
        ...
        $data['list'] = $this->home_skills_model->getCats();
	...
	public function change_skill_status()
	{
		...
		$update = $this->home_skills_model->updatecategory($data,$id);
