		...
		<input type="radio" class="custom-control-input" id="sitemap_1" name="sitemap" value="Y" checked="checked" <?php if (isset($all_data['sitemap']) && $all_data['sitemap'] == 'Y') {	echo "checked";	} ?> /><label class="custom-control-label" for="sitemap_1">On</label>
				...
				<div class="col-md-6">
                   <label class="col-form-label">7. Contact Us view</label><br />
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" class="custom-control-input" name="contact" value="Y" checked="checked" <?php if (isset($all_data['contact']) && $all_data['contact'] == 'Y') {	echo "checked";	} ?> id="contact_y" />
						<label class="custom-control-label" for="contact_y">On</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" <?php if (isset($all_data['contact']) && $all_data['contact'] == 'N') {	echo "checked";	} ?> name="contact" value="N" id="conatct_n">
						<label class="custom-control-label" for="conatct_n">Off</label>
                        </div>
				</div>
                <div class="col-md-6">
		...
		<input type="radio" class="custom-control-input" id="facebook_1" name="facebook" value="Y" checked="checked" <?php if (isset($all_data['facebook']) && $all_data['facebook'] == 'Y') {	echo "checked";	} ?> /><label class="custom-control-label" for="facebook_1">On</label>
                ...
                <div class="col-md-6">
                   <label class="col-form-label">9. Twitter view</label><br />
					<div class="custom-control custom-radio custom-control-inline">
						<input class="custom-control-input" type="radio" id="twitter_1" name="twitter" value="Y" checked="checked" <?php if (isset($all_data['twitter']) && $all_data['twitter'] == 'Y') {	echo "checked";	} ?> />
						<label class="custom-control-label" for="twitter_1">On</label>
        			</div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" <?php if (isset($all_data['twitter']) && $all_data['twitter'] == 'N') {	echo "checked";	} ?> type="radio" name="twitter" value="N" id="twitter_2">
						<label class="custom-control-label" for="twitter_2">Off</label>
                    </div>
				</div>
