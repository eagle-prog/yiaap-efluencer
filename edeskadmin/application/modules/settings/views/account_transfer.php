                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" class="form-control" name="paypal_mail" id="paypal_mail" value="<?php echo $all_data['paypal_mail'];?>">
                      <p><b>Description: </b>The PayPal email address where users pay when depositing money (via paypal), and when the user clicks on the PayPal link, they will be taken to the referral signup referred by this email address (if you don\'t have a PayPal account, use the one shown in the example).</p>
